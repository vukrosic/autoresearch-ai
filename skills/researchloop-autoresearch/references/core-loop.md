...
3. Keep the first experiment small and cheap.
4. Record every meaningful run.
5. Compare against the baseline before widening the search.
6. Update the plan when the next step or time budget changes.
