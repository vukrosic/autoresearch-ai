...
- [OpenHands GitHub README](https://github.com/OpenHands/OpenHands/blob/main/README.md)
- [OpenHands CLI README](https://github.com/OpenHands/OpenHands-CLI/blob/main/README.md)

## What They Do

OpenHands offers a broader agentic development stack: SDK, CLI, local GUI, cloud, and enterprise.

## What To Learn

- Separate a small CLI from a larger hosted product.
