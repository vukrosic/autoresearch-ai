...
- Open source npm package for agent-run experiments.
- Baseline-first experiment loops for ML repos.
- Prompt, workflow, and run ledger for Codex and Claude Code.

## Do Not Overclaim

- Not a magic model optimizer.
- Not a replacement for PhD-level judgment.
- Not guaranteed to improve every model.
- Not NVIDIA-only.
