...
1. Keep this folder out of the published npm package.
2. Save onboarding transcripts, summaries, and release proof here.
3. Use the packed tarball when you need exact reproducibility.
4. Keep onboarding tests cheap and local.
